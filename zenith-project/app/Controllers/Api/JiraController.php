    ...
    {  
        try {
            if (strtolower($this->request->getMethod()) === 'post') {
                ...
                $this->writeLog($this->request, "디버깅:".json_encode(d($changeItems)), 'jira_test_log');
