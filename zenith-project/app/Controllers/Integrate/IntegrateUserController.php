...
use App\Models\Integrate\IntegrateUserModel;
use CodeIgniter\API\ResponseTrait;

class IntegrateUserController extends BaseController
{
    use ResponseTrait;
    
    protected $integrateUser;
    protected $is_pravate_perm = false;
    public function __construct() 
    {
        $this->integrateUser = model(IntegrateUserModel::class);
    ...
    public function index()
    {
        ...
        return view('integrate/management_user', $_get);
    }
    ...
    public function getList()
    {
        if(/* $this->request->isAJAX() &&  */strtolower($this->request->getMethod()) === 'get'){
            ...
            $leadsAll = $this->integrateUser->getEventLeadCount($arg);
    ...
    public function getEventLeadCount()
    {
        if($this->request->isAJAX() && strtolower($this->request->getMethod()) === 'get'){
            ...
            $data = $this->integrateUser->getEventLeadCount($arg);
    ...
    public function getStatusCount()
    {
        if($this->request->isAJAX() && strtolower($this->request->getMethod()) === 'get'){
            ...
            $result = $this->integrateUser->getStatusCount($arg);
    ...
    public function getMemo()
    {
        if($this->request->isAJAX() && strtolower($this->request->getMethod()) === 'get'){
            $arg = $this->request->getGet();
            $result = $this->integrateUser->getMemo($arg);
    ...
    public function addMemo() {
        if($this->request->isAJAX() && strtolower($this->request->getMethod()) === 'post'){
            ...
            $result = $this->integrateUser->addMemo($arg);
    ...
    public function setStatus() {
        if($this->request->isAJAX() && strtolower($this->request->getMethod()) === 'post'){
            $arg = $this->request->getPost();
            $result = $this->integrateUser->setStatus($arg);
